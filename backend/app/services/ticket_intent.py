...
_RAISE_PATTERNS = [
    ...
    r"\bfile (a |an )?complaint\b",
    r"\b(make|submit|register|log) (a |an )?complaint\b",
    r"\bi (want|need|would like) to complain\b",
    r"\bcomplain about\b",
    r"\breport (a |an )?(problem|issue|complaint)\b",
    r"\b(i have|there is|theres|there's) (a |an )?(problem|issue|complaint)\b",
    # Arabic
    r"شكوى",
